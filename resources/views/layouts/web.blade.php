...
<html lang="en">
  <head>
  <title>@yield('title', 'Rajapaksha Traders')</title>
    <meta charset="utf-8">
  ...
  <div class="container-lg">
    <div class="row g-4">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="footer-menu">
          <img src="{{ asset('img/logo2.png') }}" width="240" height="70" alt="Company Logo" class="img-fluid footer-logo">
          <div class="social-links mt-3">
            <ul class="d-flex list-unstyled gap-2">
              <li>
                <a href="#" class="btn btn-social rounded-circle p-2">
      ...
      <div class="col-md-2 col-sm-6">
        <div class="footer-menu">
          ...
          <ul class="menu-list list-unstyled">
            <li class="menu-item mb-2">
              <a href="#" class="nav-link footer-link">FAQ</a>
            </li>
            <li class="menu-item mb-2">
              <a href="#" class="nav-link footer-link">Contact</a>
            </li>
            <li class="menu-item mb-2">
              <a href="#" class="nav-link footer-link">Privacy Policy</a>
            </li>
            <li class="menu-item mb-2">
              <a href="#" class="nav-link footer-link">Returns & Refunds</a>
            </li>
            <li class="menu-item mb-2">
              <a href="#" class="nav-link footer-link">Cookie Guidelines</a>
            </li>
            <li class="menu-item mb-2">
              <a href="#" class="nav-link footer-link">Delivery Information</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="footer-menu">
          ...
          <p class="footer-text mb-3">Subscribe to our newsletter to get updates about our grand offers.</p>
          <form class="d-flex mt-3 gap-0" action="index.html">
            <input class="form-control rounded-start rounded-0 footer-input" type="email" placeholder="Email Address" aria-label="Email Address" required>
            <button class="btn btn-subscribe rounded-end rounded-0" type="submit">Subscribe</button>
          </form>
        </div>
      </div>
    ...
    <div class="row mt-4">
      ...
      <p class="footer-copyright mb-0 small">
        &copy; 2025 Rajapaksha Traders. All rights reserved. Developed and designed by 
        <a href="https://ceylongit.online/" class="text-white">CeylonGit</a>.
    </p>
...
<style>
  ...
  .footer-dark {
    ...
    --footer-title: #ffffff;
    --footer-input-bg: #2d2d2d;
    --footer-input-text: #ffffff;
    --footer-input-border: #444444;
    --footer-btn-bg: #ff6b6b;
    --footer-btn-text: #ffffff;
    --footer-btn-hover: #ff5252;
    --footer-social-bg: transparent;
    --footer-social-border: #666666;
    --footer-social-hover: #ff6b6b;
  }
  ...
  /* Theme Switcher Example (can be placed anywhere in your page) */
  .theme-switcher {
    position: fixed;
    bottom: 20px;
    right: 20px;
...
<!-- Example Theme Switcher Button (optional) -->
